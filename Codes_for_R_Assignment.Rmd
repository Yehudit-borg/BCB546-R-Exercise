...
write.csv(colname, "colname.csv", row.names=FALSE, quote=FALSE) 
...
## Maize Vs Teosinte Comparison Plot
...
# Ensure Chromosome is treated as a numeric factor in sequential order
merged_extract_clean$Chromosome <- factor(merged_extract_clean$Chromosome, levels = sort(as.numeric(unique(merged_extract_clean$Chromosome))))
...
# Ensure Chromosome is treated as a numeric factor in sequential order (1 to 10)
Teosinte_extract_clean$Chromosome <- factor(Teosinte_extract_clean$Chromosome, levels = sort(as.numeric(unique(Teosinte_extract_clean$Chromosome))))
